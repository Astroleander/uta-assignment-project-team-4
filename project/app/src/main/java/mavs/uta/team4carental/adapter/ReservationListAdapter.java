...
public class ReservationListAdapter extends BaseAdapter {
    ...
    public ReservationListAdapter(Context ctx, ArrayList<Rental> list) {
        this.ctx = ctx;
        this.items = list;
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.item_reservation, viewGroup, false);
            /*
             * 在这里绑定字段
             */
        ...
        viewHolder.Start_date.setText(items.get(i).getStart());
        viewHolder.End_date.setText(items.get(i).getEnd());
